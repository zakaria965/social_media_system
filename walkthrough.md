...
- **Quick Create Modal**: Created an elegant modal with fields for Title, Description, Content Notes, Media (attachment simulation), Tags, Platform selector, and an AI Generate Toggle that allows generating captions directly from titles using OpenAI.
